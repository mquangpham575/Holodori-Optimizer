...
export const GUIDES = [
  {
    "id": "beginner-guide",
    "title": {
      "en": "HOLOLIVE DREAMS tips for DUMMIES",
      "vi": "HOLOLIVE DREAMS tips for DUMMIES",
      "ja": "HOLOLIVE DREAMS tips for DUMMIES",
      "zh": "HOLOLIVE DREAMS tips for DUMMIES",
      "ko": "HOLOLIVE DREAMS tips for DUMMIES",
      "de": "HOLOLIVE DREAMS tips for DUMMIES",
      "es": "HOLOLIVE DREAMS tips for DUMMIES",
      "fr": "HOLOLIVE DREAMS tips for DUMMIES",
      "th": "HOLOLIVE DREAMS tips for DUMMIES",
      "pt": "HOLOLIVE DREAMS tips for DUMMIES",
      "ru": "HOLOLIVE DREAMS tips for DUMMIES"
    },
    "summary": {
      "en": "Welcome to Hololive Dreams! Learn the basic mechanics, element advantages, and team roles to jumpstart your adventure.",
      "vi": "Chào mừng bạn đến với Hololive Dreams! Tìm hiểu các cơ chế cơ bản, chỉ số tài năng và cách xây dựng đội hình tối ưu.",
      "ja": "ホロライブドリームスへようこそ！冒険を始めるための基本メカニクス、属性相性、チームの役割を学びましょう。",
      "zh": "歡迎來到 Hololive Dreams！學習基本機制、屬性克制和隊伍角色，開啟你的冒險之旅。",
      "ko": "홀로라이브 드림스에 오신 것을 환영합니다! 모험을 시작하기 위한 기본 메커니クス, 속성 상성, 팀 역할을 알아보세요.",
      "de": "Willkommen bei Hololive Dreams! Lerne die grundlegenden Mechaniken, Elementvorteile und Teamrollen, um dein Abenteuer zu starten.",
      "es": "¡Bienvenido a Hololive Dreams! Aprende las mecánicas básicas, las ventajas elementales y los roles de equipo para comenzar tu aventura.",
      "fr": "Bienvenue dans Hololive Dreams ! Apprenez les mécaniques de base, les avantages élémentaires et les rôles d'équipe pour lancer votre aventure.",
      "th": "ยินดีต้อนรับสู่ Hololive Dreams! เรียนรู้กลไกพื้นฐาน ข้อดีของธาตุ และบทบาทของทีมเพื่อเริ่มต้นการผจญภัยของคุณ",
      "pt": "Bem-vindo ao Hololive Dreams! Aprenda as mecânicas básicas, vantagens de elementos e funções de equipe para iniciar sua aventura.",
      "ru": "Добро пожаловать в Hololive Dreams! Изучите базовую механику, преимущества стихий и роли в команде, чтобы начать свое приключение."
    },
    "category": "Guides",
    "readTime": "5 min read",
    "author": "HoloDreamer_VT",
    "date": "July 28, 2026",
    "contentUrl": {
      "en": "/blog/beginner-guide/index/index_en.md",
      "vi": "/blog/beginner-guide/index/index_vi.md",
      "ja": "/blog/beginner-guide/index/index_ja.md",
      "zh": "/blog/beginner-guide/index/index_zh.md",
      "ko": "/blog/beginner-guide/index/index_ko.md",
      "de": "/blog/beginner-guide/index/index_de.md",
      "es": "/blog/beginner-guide/index/index_es.md",
      "fr": "/blog/beginner-guide/index/index_fr.md",
      "th": "/blog/beginner-guide/index/index_th.md",
      "pt": "/blog/beginner-guide/index/index_pt.md",
      "ru": "/blog/beginner-guide/index/index_ru.md"
    }
  },
  {
    "id": "synergy-meta",
    "title": {
      "en": "Stellar Synergy: Building the Ultimate Team",
      "vi": "Hiệu Ứng Cộng Hưởng: Cách Xây Dựng Đội Hình Tối Ưu",
      "ja": "星のシナジー：究極의팀편성",
      "zh": "星光協同：構建究極隊伍",
      "ko": "스텔라 시너지: 궁극의 팀 빌딩",
      "de": "Stellare Synergie: Das ultimative Team aufbauen",
      "es": "Sinergia estelar: Construyendo el equipo definitivo",
      "fr": "Synergie stellaire : Construire l'équipe ultime",
      "th": "การประสานพลังระดับดารา: การสร้างทีมที่ดีที่สุด",
      "pt": "Sinergia Estelar: Construindo a Equipe Definitiva",
      "ru": "Звездная синергия: Создание идеального отряда"
    },
    "summary": {
      "en": "An analysis of the current meta-defining synergy combinations in Hololive Dreams. Learn how to combine buffs for massive combos.",
      "vi": "Phân tích các sự kết hợp hiệu ứng (Synergy) định hình meta hiện tại trong Hololive Dreams để tối đa hóa điểm số của bạn.",
      "ja": "ホロライブドリームスの現在のメタを定義するシナジーの分析。バフを組み合わせて大コンボを出す方法を学びましょう。",
      "zh": "分析 Hololive Dreams 中當前定義 Meta 的協同組合。了解如何組合增益以獲得巨大的連擊。",
      "ko": "홀로라이브 드림스에서 현재 메타를 정의하는 시너지 조합 분석. 버프를 조합하여 대량의 콤보를 얻는 방법을 배워보세요.",
      "de": "Eine Analyse der aktuellen meta-definierenden Synergiekombinationen in Hololive Dreams. Lerne, wie du Buffs für massive Combos kombinierst.",
      "es": "Un análisis de las combinaciones de sinergia actuales que definen el meta en Hololive Dreams. Aprende a combinar potenciadores para lograr combos masivos.",
      "fr": "Une analyse des combinaisons de synergie actuelles qui définissent la méta dans Hololive Dreams. Apprenez à combiner les buffs pour des combos massifs.",
      "th": "การวิเคราะห์การประสานพลังที่กำหนดเมตาใน Hololive Dreams เรียนรู้วิธีผสมผสานบัฟเพื่อทำคอมโบขนาดใหญ่",
      "pt": "Uma análise das combinações de sinergia atuais que definem o meta no Hololive Dreams. Aprenda a combinar buffs para combos massivos.",
      "ru": "Анализ текущих мета-синергетических комбинаций в Hololive Dreams. Узнайте, как комбинировать усиления для создания мощных комбо."
    },
    "category": "Meta",
    "readTime": "6 min read",
    "author": "Theorycrafter_KFP",
    "date": "July 30, 2026",
    "content": {
      "en": "\n# Meta Team Synergy Analysis\n\nSynergy is what separates casual players from high-ranking HoloDreamers. Here are the top team compositions for the current patch.\n\n## 1. Gen 0 Harmony (Suisei + Sora + Kobo)\nThis is currently the most popular Technique-scaling team:\n- **Primary Carry**: Hoshimachi Suisei (Gen 0 / PURE)\n- **Primary Support**: Tokino Sora (Gen 0 / HAPPY)\n- **Secondary Support**: Kobo Kanaeru (ID Gen 3 / PURE)\n\n**How it works:**\nSora and Suisei activate Sora's Outfit (+50% All Stats) and Sora's Passive (+33% All Stats to self) because there are 2 Gen 0 members. Suisei and Kobo are both PURE type, triggering Kobo's Active boost condition (+110% Score) and Suisei's Passive (+41% Technique).\n\n## 2. Gen 3 PekoMari (Marine + Pekora + Calli)\nAn incredibly strong performance-based HAPPY/CUTE team:\n- **Primary Carry**: Houshou Marine (Gen 3 / HAPPY)\n- **Tactician**: Usada Pekora (Gen 3 / CUTE)\n- **Buff Support**: Calliope Mori (Myth / HAPPY)\n\n**How it works:**\nMarine and Pekora form a Gen 3 duo, triggering Marine's Outfit (+50% All Stats) and Passive (+12% Support to Gen 3). Marine and Calliope are both HAPPY type, sharing strong stat buffs, while Pekora acts as a general cute healer and combo protector.",
      "vi": "\n# Phân Tích Hiệu Ứng Cộng Hưởng Meta\n\nCộng hưởng hiệu ứng (Synergy) là điểm khác biệt giữa người chơi thông thường và những HoloDreamers xếp hạng cao. Dưới đây là các đội hình mạnh nhất phiên bản hiện tại.\n\n## 1. Gen 0 Harmony (Suisei + Sora + Kobo)\nĐội hình theo thiên hướng Technique (Kỹ thuật) mạnh nhất hiện nay:\n- **Sát thương chính**: Hoshimachi Suisei (Gen 0 / PURE)\n- **Hỗ trợ cốt lõi**: Tokino Sora (Gen 0 / HAPPY)\n- **Hỗ trợ bổ sung**: Kobo Kanaeru (ID Gen 3 / PURE)\n\n**Cách vận hành:**\nSora và Suisei kích hoạt Outfit của Sora (+50% chỉ số) và Passive của Sora (+33% chỉ số tự thân) do có 2 thành viên thế hệ Gen 0. Suisei và Kobo đều hệ PURE, giúp kích hoạt điều kiện buff của Kobo (+110% điểm số) và Passive của Suisei (+41% Technique).\n\n## 2. Gen 3 PekoMari (Marine + Pekora + Calli)\nĐội hình theo thiên hướng Performance (Biểu diễn) siêu mạnh:\n- **Sát thương chính**: Houshou Marine (Gen 3 / HAPPY)\n- **Kích buff phụ**: Usada Pekora (Gen 3 / CUTE)\n- **Hỗ trợ đa dụng**: Calliope Mori (Myth / HAPPY)\n\n**Cách vận hành:**\nMarine và Pekora tạo liên kết thế hệ Gen 3, kích hoạt Outfit của Marine (+50% chỉ số) và Passive (+12% hỗ trợ Gen 3). Marine và Calliope đều thuộc hệ HAPPY, giúp kích hoạt dồn buff chỉ số biểu diễn, trong khi Pekora đóng vai trò giữ chuỗi combo và hồi phục.",
      "ja": "# メタチーム編成のシナジー分析\n\nシナジー（相乗効果）こそが、カジュアルプレイヤーと上位のHoloDreamersを分ける要素です。\n\n## 1. 0期生ハーモニー (すいせい + そら + こぼ)\n現在、最も人気の高いテクニックスケールチームです：\n- **メインキャリー**: 星街すいせい (0期生 / PURE)\n- **メインサポート**: ときのそら (0期生 / HAPPY)\n- **サブサポート**: こぼ・かなえる (ID3期生 / PURE)\n\n## 2. 3期生ぺこまり (マリン + ぺこら + カリオペ)\nパフォーマンス重視の非常に強力なHAPPY/CUTEチームです。",
      "zh": "# Meta 隊伍協同分析\n\n協同作用（Synergy）是區分普通玩家和高階 HoloDreamers 的關鍵。\n\n## 1. Gen 0 和諧組合 (星街彗星 + 時乃空 + Kobo)\n這是目前最受歡迎的技術流隊伍：\n- **核心輸出**：星街彗星 (Gen 0 / PURE)\n- **核心輔助**：時乃空 (Gen 0 / HAPPY)\n- **次要輔助**：Kobo Kanaeru (ID Gen 3 / PURE)\n\n## 2. Gen 3 兔協組合 (寶鐘瑪琳 + 兔田佩克拉 + Calliope)\n一個極其強大的表演流 HAPPY/CUTE 隊伍。",
      "ko": "# 메타 팀 시너지 분석\n\n시너지야말로 일반 플레이어와 상위 HoloDreamers를 구분 짓는 기준입니다.\n\n## 1. 0기생 하모니 (스이세이 + 소라 + 코보)\n현재 가장 인기 있는 기술(Technique) 스케일링 팀입니다:\n- **메인 딜러**: 호시마치 스이세이 (0기생 / PURE)\n- **메인 버퍼**: 토키노 소라 (0기생 / HAPPY)\n- **서브 버퍼**: 코보 카나에루 (ID 3기생 / PURE)\n\n## 2. 3기생 페코마리 (마린 + 페코라 + 칼리오페)\n공연(Performance) 스탯 중심의 매우 강력한 HAPPY/CUTE 팀입니다.",
      "de": "# Meta-Team-Synergie-Analyse\n\nSynergien sind das, was Gelegenheitsspieler von hochrangigen HoloDreamers unterscheidet.\n\n## 1. Gen 0 Harmonie (Suisei + Sora + Kobo)\nDies ist derzeit das beliebteste auf Technik skalierende Team.\n\n## 2. Gen 3 PekoMari (Marine + Pekora + Calli)\nEin leistungsorientiertes HAPPY/CUTE-Team.",
      "es": "# Análisis de Sinergia del Equipo Meta\n\nLa sinergia es lo que separa a los jugadores casuales de los HoloDreamers de alto rango.\n\n## 1. Armonía de la Gen 0 (Suisei + Sora + Kobo)\nEste es actualmente el equipo de escalado de técnica más popular.\n\n## 2. PekoMari de la Gen 3 (Marine + Pekora + Calli)\nUn equipo HAPPY/CUTE increíblemente fuerte basado en el rendimiento.",
      "fr": "# Meta Team Synergy Analysis\n\nSynergy is what separates casual players from high-ranking HoloDreamers.\n\n## 1. Gen 0 Harmony (Suisei + Sora + Kobo)\nThis is currently the most popular Technique-scaling team.\n\n## 2. Gen 3 PekoMari (Marine + Pekora + Calli)\nAn incredibly strong performance-based HAPPY/CUTE team.",
      "th": "# Meta Team Synergy Analysis\n\nSynergy is what separates casual players from high-ranking HoloDreamers.\n\n## 1. Gen 0 Harmony (Suisei + Sora + Kobo)\nThis is currently the most popular Technique-scaling team.\n\n## 2. Gen 3 PekoMari (Marine + Pekora + Calli)\nAn incredibly strong performance-based HAPPY/CUTE team.",
      "pt": "# Meta Team Synergy Analysis\n\nSynergy is what separates casual players from high-ranking HoloDreamers.\n\n## 1. Gen 0 Harmony (Suisei + Sora + Kobo)\nThis is currently the most popular Technique-scaling team.\n\n## 2. Gen 3 PekoMari (Marine + Pekora + Calli)\nAn incredibly strong performance-based HAPPY/CUTE team.",
      "ru": "# Meta Team Synergy Analysis\n\nSynergy is what separates casual players from high-ranking HoloDreamers.\n\n## 1. Gen 0 Harmony (Suisei + Sora + Kobo)\nThis is currently the most popular Technique-scaling team.\n\n## 2. Gen 3 PekoMari (Marine + Pekora + Calli)\nAn incredibly strong performance-based HAPPY/CUTE team."
    }
  },
  {
    "id": "bypass-region-lock",
    "title": {
      "en": "How to Bypass Region Lock & Log In",
      "vi": "Hướng Dẫn Vượt Chặn Vùng (Bypass Region Lock) & Đăng Nhập",
      "ja": "地域制限の解除とログイン方法",
      "zh": "如何繞過地區限制與登入",
      "ko": "지역 제한 우회 및 로그인 방법",
      "de": "Region-Lock umgehen & einloggen",
      "es": "Cómo omitir el bloqueo de región e iniciar sesión",
      "fr": "Comment contourner le blocage régional et se connecter",
      "th": "วิธีเลี่ยงการล็อกภูมิภาคและเข้าสู่ระบบ",
      "pt": "Como Contornar o Bloqueio de Região e Fazer Login",
      "ru": "Как обойти региональную блокировку и войти"
    },
    "summary": {
      "en": "Detailed step-by-step guide to download, install, and bypass region restrictions using VPN.lat on Android and SoftEther VPN on Windows.",
      "vi": "Hướng dẫn chi tiết từng bước để tải, cài đặt và vượt chặn vùng địa lý bằng VPN.lat trên Android và SoftEther VPN trên Windows.",
      "ja": "AndroidのVPN.latおよびWindowsのSoftEther VPNを使用して、地域制限を解除してダウンロード、インストール、ログインする詳細な手順。",
      "zh": "詳細的分步指南，教你如何在 Android 上使用 VPN.lat 以及在 Windows 上使用 SoftEther VPN 繞過地區限制進行下載、安裝和登入。",
      "ko": "안드로이드의 VPN.lat 및 윈도우의 SoftEther VPN을 사용하여 다운로드, 설치, 지역 제한 우회 로그인을 하는 자세한 방법。",
      "de": "Detaillierte Schritt-für-Schritt-Anleitung zum Herunterladen, Installieren und Umgehen von Regionseinschränkungen mit VPN.lat auf Android und SoftEther VPN auf Windows.",
      "es": "Guía detallada paso a paso para descargar, instalar y omitir las restricciones de región utilizando VPN.lat en Android y SoftEther VPN en Windows.",
      "fr": "Guide détaillé étape par étape pour télécharger, installer et contourner les restrictions régionales à l'aide de VPN.lat sur Android et SoftEther VPN sur Windows.",
      "th": "คู่มือทีละขั้นตอนโดยละเอียดในการดาวน์โหลด ติดตั้ง และเลี่ยงการจำกัดภูมิภาคโดยใช้ VPN.lat บน Android และ SoftEther VPN บน Windows",
      "pt": "Guia passo a passo detalhado para baixar, instalar e contornar as restrições de região usando o VPN.lat no Android e SoftEther VPN no Windows.",
      "ru": "Подробное пошаговое руководство по загрузке, установке и обходу региональных ограничений с помощью VPN.lat на Android и SoftEther VPN в Windows."
    },
    "category": "Guides",
    "readTime": "4 min read",
    "author": "HoloDreamer_VT",
    "date": "August 1, 2026",
    "contentUrl": {
      "en": "/blog/bypass-region-lock/index/index_en.md",
      "vi": "/blog/bypass-region-lock/index/index_vi.md",
      "ja": "/blog/bypass-region-lock/index/index_ja.md",
      "zh": "/blog/bypass-region-lock/index/index_zh.md",
      "ko": "/blog/bypass-region-lock/index/index_ko.md",
      "de": "/blog/bypass-region-lock/index/index_de.md",
      "es": "/blog/bypass-region-lock/index/index_es.md",
      "fr": "/blog/bypass-region-lock/index/index_fr.md",
      "th": "/blog/bypass-region-lock/index/index_th.md",
      "pt": "/blog/bypass-region-lock/index/index_pt.md",
      "ru": "/blog/bypass-region-lock/index/index_ru.md"
    },
    "content": ""
  }
];

export const DEFAULT_USER_SHOWCASE = {
  "playerName": "HoloDreamer_Quang",
  "title": "Arch-HoloDreamer",
  "level": 45,
  "server": "Global-1",
  "favoriteCharacters": [
    "tokinosora",
  ...
  "achievements": [
    {
      "id": "first_ssr",
      "title": "Dream Begun",
      "desc": "Summoned your first 5-Star Holo-Talent",
      "unlocked": true
    },
    {
      "id": "cleared_ch5",
      "title": "Dream Conqueror",
      "desc": "Cleared Stage 5-10: The Abyss of Memory",
      "unlocked": true
    },
    {
      "id": "max_synergy",
      "title": "Perfect Harmony",
      "desc": "Activated a 3-way synergy bonus",
      "unlocked": false
    },
    {
      "id": "speed_demon",
      "title": "Stellar Master",
      "desc": "Reached 95+ Technique on a single character",
      "unlocked": false
    }
  ],
  "favoriteTeam": [
